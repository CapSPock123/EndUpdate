...
public class NetheriteElytraChestplateLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> implements IForgeElytraLayer<T> {
    private final NetheriteElytraChestplateModel<T> netheriteElytraChestplateModel;

    public NetheriteElytraChestplateLayer(RenderLayerParent<T, M> pRenderer, EntityModelSet pModelSet) {
        super(pRenderer);
        this.netheriteElytraChestplateModel = new NetheriteElytraChestplateModel<>(pModelSet.bakeLayer(NetheriteElytraChestplateModel.WINGS_LOCATION));
    }
    ...
    public ResourceLocation getElytraTexture(ItemStack stack, T entity) {
        return NetheriteElytraChestplateModel.RESOURCE_LOCATION;
    }
}
