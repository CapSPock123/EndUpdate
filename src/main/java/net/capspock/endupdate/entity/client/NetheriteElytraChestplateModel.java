...
public class NetheriteElytraChestplateModel <T extends LivingEntity> extends AgeableListModel<T> {
    public static final ModelLayerLocation WINGS_LOCATION = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("textures/entity/elytra.png"), "main");
    public static final ResourceLocation RESOURCE_LOCATION = ResourceLocation.withDefaultNamespace("textures/entity/elytra.png");

    private final ModelPart rightWing;
    private final ModelPart leftWing;

    public NetheriteElytraChestplateModel(ModelPart pRoot) {
