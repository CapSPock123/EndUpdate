    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, ENDERSTEEL_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.ENDERSTEEL_ORE_KEY),
                ModOrePlacement.commonOrePlacement(2,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(11), VerticalAnchor.absolute(24))));

    }

    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(EndUpdate.MOD_ID, name));
    }
