...
public class EnderSlimeballParticles extends BreakingItemParticle {

    protected EnderSlimeballParticles(ClientLevel pLevel, double pX, double pY, double pZ, ItemStack pStack) {
    ...
    public static class EnderSlimeProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ,
            ...
            return new EnderSlimeballParticles(pLevel, pX, pY, pZ, new ItemStack(ModItems.ENDER_SLIMEBALL.get()));
        }
    }
}
