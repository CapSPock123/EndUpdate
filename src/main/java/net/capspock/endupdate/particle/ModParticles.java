...
public class ModParticles {
    ...
    public static final RegistryObject<SimpleParticleType> ITEM_ENDER_SLIME_PARTICLES =
            PARTICLE_TYPES.register("item_ender_slime_particles", () -> new SimpleParticleType(true));
