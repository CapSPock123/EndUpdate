...
public class ModToolTiers {
    public static final Tier ENDERSTEEL = TierSortingRegistry.registerTier(
            ...
            ResourceLocation.fromNamespaceAndPath(EndUpdate.MOD_ID, "endersteel"), List.of(Tiers.NETHERITE), List.of());
    ...
    public static final Tier DIAMOND_BLOCK = TierSortingRegistry.registerTier(
            ...
            ResourceLocation.fromNamespaceAndPath(EndUpdate.MOD_ID, "diamond_block"), List.of(Tiers.IRON), List.of());
