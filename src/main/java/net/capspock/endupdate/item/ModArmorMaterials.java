...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> SHULKER_PLATED_NETHERITE_ARMOR_MATERIAL = register("shulker_plated_netherite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 17, 3.5f, 0.15f, () -> ModItems.SHULKER_PLATE.get());
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(EndUpdate.MOD_ID, name);
